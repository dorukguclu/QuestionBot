...
class ViewController: UIViewController {
    ...
    let myQuestionAnswerer = QuestionAnswerer() // Correctly declare this object
    ...
    func respondToQuestion(_ question: String) {
        // Use the correct property name `myQuestionAnswerer`
        let answer = myQuestionAnswerer.responseTo(question: question)
